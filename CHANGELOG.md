...
- Adds the unpromoted namespaced ASTRA active-support audit draft under `resources/active-support-audit/draft-v0.1.0`. It explains legal SPPT variation classes, a proposed mode/support interface, core versus proposed prediction tiers, dimensional obligations, case-specific falsifiers, and a dark-matter evidence firewall. It does not change the SPPT core, claim matrix, release assets, or any GitHub Release, Pages, DOI, or Zenodo state; the draft is visible only as ordinary default-branch repository content after an authorized push.
